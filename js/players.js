class Player {
    ...
    constructor(gameScreen, gameSize,) {
        ...
        this.initialPlayerPos = {
            left: 100,
            top: gameSize.h / 2 - this.playerSize.h
        }
    ...
    jump() {
        this.playerVel.top = -1.5

        setTimeout(() => {
            this.playerVel.top += this.playerVel.gravity * 10
        }, 150)
    }

    resetPosition() {
        
        this.playerPos.left = this.initialPlayerPos.left;
        this.playerPos.top = this.initialPlayerPos.top;
        this.updatePosition(); 
    }
}
