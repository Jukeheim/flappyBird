...
const Game = {
    ...
    winner() {
        this.createCenterText('Good Job!');
        this.redirectToHome();
        this.removeCenterText();
        const centerText = document.createElement("div");
        centerText.classList.add("center-text");
        centerText.textContent = "Good Job";

        this.gameScreen.appendChild(centerText);
    ...
    gameOver() {
        this.createCenterText('You Suck!');
        this.redirectToHome();
        this.removeCenterText();
        const centerText = document.createElement("div");
        centerText.classList.add("center-text");
        centerText.textContent = "You Suck";
